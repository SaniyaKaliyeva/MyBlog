            ...
            public void handle(ActionEvent event) {               
                if(!login.getText().toString().equals("") && !password.getText().toString().equals("")){
                    ...
                    String ref = null;
                                ...
                                public void handle(MouseEvent event){
                                    ...
                                    others.setOnMouseClicked(new EventHandler<MouseEvent>(){
                                        ...
                                        public void handle(MouseEvent event) {
                                            ...
                                            ListView profileOfUsers = new ListView();
                                            ...
                                            try{
                                                ResultSet rs=connectToDB().executeQuery("select name, surname, login, dateofb, position, salary,img from users;");
                                                while(rs.next()){
                                                  imageOfUser= new Circle(30);
                                                  imageOfUser.setStroke(Color.GREEN);
                                                  System.out.println(rs.getString(1));
                                                  loginOfUsers.add(rs.getString(3));
                                                  ref=rs.getString(7);//reference
                                                  img=new Image(new FileInputStream(ref));
                                            ...
                                            allroot.getChildren().addAll(profileOfUsers,blogOfUser,back);
                        ...
                        try{
                            ResultSet rs=connectToDB().executeQuery("select name, surname, phone_number, dateofb, position, salary,img from users where login='"+lg+"';");
                            while(rs.next()){
                                System.out.println(rs.getString(1));
                            ...
                            Image im=new Image(new FileInputStream(ref));
            ...
            public void handle(MouseEvent event) {
                ...
                reg.setOnAction(new EventHandler<ActionEvent>(){//Логин
                    ...
                    public void handle(ActionEvent event) {
                        ...
                        try {
                        connectToDB().executeUpdate("insert into users(login, password, phone_number, name, surname, dateofb, position, salary, img) values('"+logdb+"','"+passdb+"','"+phone_numbdb+"','"+namedb+"','"+surnamedb+"','"+datedb+"','"+positiondb+"','"+salarydb+"','"+imgdb+"')");                  
                            st.close();
                        } catch (SQLException ex) {
                            Logger.getLogger(Bank.class.getName()).log(Level.SEVERE, null, ex);
                        }
                ...
                regroot.getChildren().addAll(name,nametext,sname,snametext,
                        ...
                        salary,salarytext,image,imagetext,reg,error);
